...
'/config/chain/base.js'; // Change Chain
import { CONTRACT_BASE } from 
...
const LOLappAddress = CONTRACT_BASE; // power send contract
...
async function updatePowerstats() {
    ...
    // HTML elements
    document.getElementById('PowerNumber').innerText = "4"; 
}
